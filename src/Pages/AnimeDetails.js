  ...
  return (
    <div className="AnimeDetails p-4 flex items-center justify-center">
      <div className="container">
        <div
          className="grid grid-cols-1 md:grid-cols-12 gap-8 text-white rounded-2xl p-6 relative"
          style={{
        ...
        >
          ...
          <div className="md:col-span-5 relative z-10">
            <img
              src={mainImage}
              alt={anime.title}
              className="w-full h-auto rounded-lg shadow-[0_0_30px_5px_rgba(255,230,0,0.4)]"
            />
          </div>
          ...
          <div className="md:col-span-7 relative z-10">
            ...
            {/* Continue Watching */}
            <div className="bg-[#1a1a1a]/80 rounded-2xl p-5 mt-6 shadow-[0_0_25px_3px_rgba(255,255,0,0.3)]">
              <Link
                to="/"
                ...
                >
                  {related.map((item) => (
                    <SwiperSlide key={item.mal_id}>
                      <div className="bg-[#111]/90 rounded-xl p-3 flex gap-4 items-start hover:bg-[#1a1a1a] transition transform hover:scale-[1.03] duration-300">
                        <img
                          src={mainImage}
                          alt={item.name}
